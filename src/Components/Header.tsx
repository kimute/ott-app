        ...
        <Navigation 
            ...
            <Column>
                ...
                <Items>
                    <Item>
                        <Link to="/home">
                        Home & Movie {isHome?.isExact && <Circle layoutId="point"/>}
                        </Link>
                    </Item>
                    <Item>
                        <Link to="/tv">
            ...
            <Column>
                <Search onSubmit={handleSubmit(checkValid)}>
                  <motion.svg
                    onClick={openToggleSlide}
                    animate={{ x: slide ? -185 : 0}}
