...
import { getPopular, getUpcomming, getVideos, IGetMovie} from "../api";
...
function PopularSlider(){
    ...
    const routeMovieMatch = useRouteMatch<{movieId: string}>("/home/movies/popular/:movieId");
    const { data, isLoading } = useQuery<IGetMovie>(["movie", "popular"], getPopular);
    ...
    const onMovieClick = (movieId: number) =>{
        history.push(`/home/movies/popular/${movieId}`);
