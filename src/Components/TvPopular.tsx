...
import { getPopular, getTvPopular, getTvVideos, getVideos, IGetMovie, ITvpop} from "../api";
...
function PopularSlider(){
    ...
    const routeMovieMatch = useRouteMatch<{tvId: string}>("/tv/onair/popular/:tvId");
    const { data, isLoading } = useQuery<ITvpop>(["tv", "popular"], getTvPopular);
    ...
    const oonTvClick = (tvId: number) =>{
        history.push(`/tv/onair/popular/${tvId}`);
        ...
        <Wrapper>
            {isLoading ? 
                ...
                (<>
                    ...
                    <MiniTitle>Tv Popular {'>'} </MiniTitle>
